...
def _worker_process_segment(byte_offset_start: int, byte_offset_end: int, round_floats: bool,
    ...
    try:
        ...
        print(f"[ERROR] Worker failed ({byte_offset_start:,}-{byte_offset_end:,}): {err}")
        raise
...
def _worker_thread_segment(
    ...
    try:
        ...
        print(f"[ERROR] Thread failed ({byte_offset_start:,}-{byte_offset_end:,}): {err}")
        raise
...
class ParallelBinDecoder:
    ...
    def _run_with_processes(
        ...
        print(f"[INFO] Using Multiprocessing Pool ({self.num_workers} processes)...")
    ...
    def _run_with_threads(
        ...
        print(f"[INFO] Using ThreadPoolExecutor ({self.num_workers} threads)...")
